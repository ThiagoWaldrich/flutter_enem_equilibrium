import 'package:equilibrium/screens/audodiagnostico/register_tab.dart';
import 'package:equilibrium/screens/audodiagnostico/charts_tab.dart';
...
class _AutodiagnosticoScreenState extends State<AutodiagnosticoScreen>
  ...
  void _updateTopics() {
    ...
    if (_selectedSubject != null &&
      ...
      _availableTopics.addAll(
        SubjectDataConstants.subjectData[_selectedSubject]!.keys
      );
    }
    setState(() {});
  }
  ...
  void _updateSubtopics() {
    ...
    if (_selectedSubject != null &&
        _selectedTopic != null &&
        SubjectDataConstants.subjectData.containsKey(_selectedSubject) &&
        SubjectDataConstants.subjectData[_selectedSubject]!.containsKey(_selectedTopic)) {
  ...
  Future<Map<String, Map<String, dynamic>>> _calculateErrorStats(
    ...
    for (final q in questions) {
      ...
      if (q.errors['conteudo'] == true) errorStats[subject]!['conteudo']++;
      if (q.errors['atencao'] == true) errorStats[subject]!['atencao']++;
      if (q.errors['tempo'] == true) errorStats[subject]!['tempo']++;
    }
    return errorStats;
  }
  ...
  Future<void> _loadFilteredQuestions() async {
    ...
    try {
      ...
      if (_filterErrorTypeNotifier.value != null) {
        filtered = questions.where((q) => 
          q.errors[_filterErrorTypeNotifier.value] == true
        ).toList();
      }
  ...
  Future<void> _saveQuestion() async {
    ...
    if (_imageFilePath != null) {
      final file = File(_imageFilePath!);
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (question.subtopic != null) Text('Subtópico: ${question.subtopic}'),
  ...
  Widget _buildRegisterTab() {
    return RegisterTab(
      ...
      onAttentionErrorChanged: (value) => setState(() => _attentionError = value),
                ...
                builder: (context, filterValue, _) {
                  return DropdownButtonFormField<String?>(
                    ...
                    items: [
                      ...
                      ..._subjectStats.keys.map((s) => DropdownMenuItem(value: s, child: Text(s))),
                    ],
          ...
          child: _displayedQuestions.isEmpty
              ...
              : NotificationListener<ScrollNotification>(
                  ...
                  child: ListView.separated(
                    padding: const EdgeInsets.all(16),
                    itemCount: _displayedQuestions.length + (_hasMoreQuestions ? 1 : 0),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          title: Text(question.subject, style: const TextStyle(fontWeight: FontWeight.w600)),
  ...
  Widget _buildNotebookTab() {
    ...
    return QuestionsGridView(questions: _displayedQuestions);
  }
}