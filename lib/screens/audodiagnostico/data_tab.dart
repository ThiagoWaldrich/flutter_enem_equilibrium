  ...
  List<Question> _getFilteredQuestions() {
    ...
    if (filterErrorType != null && filterErrorType.isNotEmpty) {
      filtered = filtered.where((q) {
        return q.errors[filterErrorType] == true;
      }).toList();
    }
                      ...
                      return DropdownButton<String?>(
                        ...
                        items: [
                          ...
                          ...SubjectDataConstants.subjectData.keys
                              .where((subject) => widget.subjectStats.containsKey(subject))
                      ...
                      return DropdownButton<String?>(
                        ...
                        items: [
                          ...
                          ...SubjectDataConstants.years
                              .where((year) => widget.yearStats.containsKey(year))
                      ...
                      return DropdownButton<String?>(
                        ...
                        items: [
                          ...
                          ...SubjectDataConstants.sources
                              .where((source) => widget.sourceStats.containsKey(source))
